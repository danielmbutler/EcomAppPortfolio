...
import com.example.ecomapp.models.Address
import com.example.ecomapp.models.CartItem
import com.example.ecomapp.models.Order
import com.example.ecomapp.models.Product
import com.example.ecomapp.ui.adapters.CartItemsListAdapter
...
class CheckoutActivity : BaseActivity() {
    ...
    fun successCartItemsList(cartList: ArrayList<CartItem>) {
        ...
        tv_checkout_sub_total.text = "$${mSubTotal.roundTo(2)}"
        ...
        if (mSubTotal > 0) {
            ...
            tv_checkout_total_amount.text = "$${mTotalAmount.roundTo(2)}"
        } else {
